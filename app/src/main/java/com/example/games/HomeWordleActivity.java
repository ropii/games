...
public class HomeWordleActivity extends AppCompatActivity implements View.OnClickListener {
    EditText et_add;
    Button btn_save,btn_move_to_game,btn_see_words,btn_home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_wordle);
    ...
    public void onClick(View view) {
        ...
        if (view==btn_move_to_game){
            it = new Intent(this, WordleGameActivity.class);
            startActivity(it);
        }
